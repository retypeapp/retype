...
The following [!badge NEW|info] icons are included in Retype **v4.6.0-preview**:
...
As of v4.6.0-preview, there are 371 [Octicons](https://primer.github.io/octicons/) supported and more being added with each new release.
