...
The following [!badge NEW|info] icons are included in Retype **v4.5.0-preview**:
...
As of v4.5.0-preview, there are 371 [Octicons](https://primer.github.io/octicons/) supported and more being added with each new release.
...
| :icon-book-locked: | book-locked | `:icon-book-locked:` |
| :icon-bookmark: | bookmark | `:icon-bookmark:` |
| :icon-bookmark-fill: | bookmark-fill | `:icon-bookmark-fill:` |
| :icon-bookmark-filled: | bookmark-filled | `:icon-bookmark-filled:` |
...
| :icon-comment-locked: | comment-locked | `:icon-comment-locked:` |
| :icon-compose: | compose | `:icon-compose:` |
...
| :icon-feed-issue-reopen: | feed-issue-reopen | `:icon-feed-issue-reopen:` |
...
| :icon-filter-remove: | filter-remove | `:icon-filter-remove:` |
...
| :icon-git-pull-request-locked: | git-pull-request-locked | `:icon-git-pull-request-locked:` |
...
| :icon-issue-locked: | issue-locked | `:icon-issue-locked:` |
...
| :icon-spacing-medium: | spacing-medium | `:icon-spacing-medium:` |
| :icon-spacing-small: | spacing-small | `:icon-spacing-small:` |
| :icon-sparkle: | sparkle | `:icon-sparkle:` |
| :icon-sparkle-fill: | sparkle-fill | `:icon-sparkle-fill:` |
| :icon-sparkles-fill: | sparkles-fill | `:icon-sparkles-fill:` |
| :icon-split-view: | split-view | `:icon-split-view:` |
