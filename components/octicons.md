...
The following [!badge NEW|info] icons are included in Retype **v4.5.2**:
...
As of v4.5.2, there are 371 [Octicons](https://primer.github.io/octicons/) supported and more being added with each new release.
