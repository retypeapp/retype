...
Mermaid [directives](https://mermaid-js.github.io/mermaid/#/directives) can be configured using the recommended `` syntax as the first line just inside the `` ```mermaid `` block.
