...
Retype gives you full control over the look and feel of your callout components through customizable [theme variables](/configuration/theme-variables.md).
...
To learn more about theme variables and how they work across Retype, check out the [Themes Guide](/guides/themes.md), the [Theme Variables](/configuration/theme-variables.md) documentation, and [`theme`](/configuration/project.md#theme) Project settings.
