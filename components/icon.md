...
For example, to add the [`star`](/components/octicons.mdstar-24) icon, use the `:icon-star:` icon shortcode. :icon-star:
...
Some icon shortcode names are made up of `two-or-more` words. For instance, the [`git-branch`](/components/octicons.mdgit-branch-24) icon would be configured as `:icon-git-branch:`. :icon-git-branch:
