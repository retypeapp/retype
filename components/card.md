...
```md
[!card layout="vert" footer="Custom footer"](/blog/2026-04-07-whats-new-in-retype-v450.md)
```
...
```md
[!card layout="vert" kicker="Release note"](/blog/2026-04-07-whats-new-in-retype-v450.md)
```
...
[!card layout="vertical"](/blog/2026-03-23-whats-new-in-retype-v440.md)
```
...
```md
[!card layout="vert" text="Read the `v4.1` release summary."](/blog/2026-03-23-whats-new-in-retype-v440.md)
```
...
```md
[!card layout="vert" title="Start with v4.2"](/blog/2026-04-07-whats-new-in-retype-v450.md)
```
