...
Block comments can span multiple lines by using opening `` at the start and end of the comment block. Everything between the opening and closing `%%` will be removed.
