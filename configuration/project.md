...
| `d` | Day of month | `dateFormat: d` | 15 |
| `dd` | Two-digit day of month | `dateFormat: dd` | 15 |
...
| --- | --- |
| `dateFormat: yyyy-MM-dd` | 2026-04-15 |
| `dateFormat: MM/dd/yyyy` | 04/15/2026 |
| `dateFormat: dd MMM yyyy` | 15 Apr 2026 |
| `dateFormat: MMM d, yyyy` | Apr 15, 2026 |
| `dateFormat: MMMM d, yyyy` | April 15, 2026 |
| `dateFormat: dddd, MMMM d, yyyy` | Wednesday, April 15, 2026 |
