...
| `d` | Day of month | `dateFormat: d` | 20 |
| `dd` | Two-digit day of month | `dateFormat: dd` | 20 |
...
| `dateFormat: MMM d, yyyy` | May 20, 2026 |
| `dateFormat: MMMM d, yyyy` | May 20, 2026 |
| `dateFormat: dddd, MMMM d, yyyy` | Wednesday, May 20, 2026 |
