...
| `d` | Day of month | `dateFormat: d` | 11 |
| `dd` | Two-digit day of month | `dateFormat: dd` | 11 |
...
| --- | --- |
| `dateFormat: yyyy-MM-dd` | 2026-04-11 |
| `dateFormat: MM/dd/yyyy` | 04/11/2026 |
| `dateFormat: dd MMM yyyy` | 11 Apr 2026 |
| `dateFormat: MMM d, yyyy` | Apr 11, 2026 |
| `dateFormat: MMMM d, yyyy` | April 11, 2026 |
| `dateFormat: dddd, MMMM d, yyyy` | Saturday, April 11, 2026 |
