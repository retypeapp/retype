...
| `d` | Day of month | `dateFormat: d` | 4 |
| `dd` | Two-digit day of month | `dateFormat: dd` | 04 |
...
| --- | --- |
| `dateFormat: yyyy-MM-dd` | 2026-04-04 |
| `dateFormat: MM/dd/yyyy` | 04/04/2026 |
| `dateFormat: dd MMM yyyy` | 04 Apr 2026 |
| `dateFormat: MMM d, yyyy` | Apr 4, 2026 |
| `dateFormat: MMMM d, yyyy` | April 4, 2026 |
| `dateFormat: dddd, MMMM d, yyyy` | Saturday, April 4, 2026 |
