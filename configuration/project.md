...
| `d` | Day of month | `dateFormat: d` | 2 |
| `dd` | Two-digit day of month | `dateFormat: dd` | 02 |
...
| --- | --- |
| `dateFormat: yyyy-MM-dd` | 2026-06-02 |
| `dateFormat: MM/dd/yyyy` | 06/02/2026 |
| `dateFormat: dd MMM yyyy` | 02 Jun 2026 |
| `dateFormat: MMM d, yyyy` | Jun 2, 2026 |
| `dateFormat: MMMM d, yyyy` | June 2, 2026 |
| `dateFormat: dddd, MMMM d, yyyy` | Tuesday, June 2, 2026 |
