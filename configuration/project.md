...
| `d` | Day of month | `dateFormat: d` | 29 |
| `dd` | Two-digit day of month | `dateFormat: dd` | 29 |
| `ddd` | Abbreviated day name | `dateFormat: ddd` | Fri |
| `dddd` | Full day name | `dateFormat: dddd` | Friday |

Common full date strings can be composed by combining the supported specifiers:

| Template sample | Output | {.compact}
| --- | --- |
| `dateFormat: yyyy-MM-dd` | 2026-05-29 |
| `dateFormat: MM/dd/yyyy` | 05/29/2026 |
| `dateFormat: dd MMM yyyy` | 29 May 2026 |
| `dateFormat: MMM d, yyyy` | May 29, 2026 |
| `dateFormat: MMMM d, yyyy` | May 29, 2026 |
| `dateFormat: dddd, MMMM d, yyyy` | Friday, May 29, 2026 |
