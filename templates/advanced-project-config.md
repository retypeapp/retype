...
The following `retype.yml` includes all possible [project configuration](/configuration/project.md) options.
...
links: # A list of custom links to add to the top bar of the generated website.
  ...
  - text: API
    ...
    iconAlign: right # Icon alignment, to the right or left.
...
edit:
  ...
  base: ""   # Otional base path to a directory within the above repo.
...
templating:
  ...
  liquid: false # Is Liquid syntax {% ... %} is enabled?
