...
| [!badge text="PRO" variant="info"] [Backlinks](/components/backlinks.md) component | :icon-x: | :icon-check-circle-fill: | :icon-check-circle-fill: |
...
- You purchase today
- Current release is Retype `v4.5.0-preview6`
