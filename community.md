...
Please see the [announcement](/blog/2025-06-06-new-gitHub-pages-community-key.md), [GitHub Pages](/hosting/github-pages.md) setup, and Retype [Key setup](/guides/key-setup.md) instructions.
...
Add the above [community](/community.md) key to your [Retype Wallet](/guides/cli.md#retype-wallet) using the `retype wallet --add <key>` command. The command below includes the full `<key>` making it easy to copy/paste:
...
Please review all options for [key setup](/guides/key-setup.md).
...
--- | --- | ---
[GitHub Pages](/hosting/github-pages.md) | `*.github.io` | [Retype](https://retype.com)
