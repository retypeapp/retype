...
You can add the above [community](/community.md) key to your [Retype Wallet](/guides/cli.md#retype-wallet) using the `retype wallet --add <key>` command. The command below includes the full `<key>` making it easy to copy/paste:
...
With the community key, you can now setup your project to be hosted using **GitHub Pages**. Please review the documentation to configure a [GitHub Pages](/hosting/github-pages.md) project with Retype with automatic deployment using [GitHub Actions](/guides/github-actions.md).
