...
See the full [changelog](/changelog.md#v3100) for the `v3.10` release.
...
You can now add hidden [comments](/components/comments.md) to your markdown that won't appear in the final website, making it easier to leave notes for yourself or your team. See [docs](/components/comments.md).

### Inline Comments

Add comments anywhere in your text using the `` syntax:
...
A new [callout](/components/callout.md) type has been added specifically for helpful tips, complete with a lightbulb icon.
