...
!!!tip Community Key
Read about the free [Community](/blog/2025-06-06-new-gitHub-pages-community-key.md) key if hosting on [GitHub Pages](/hosting/github-pages.md) and unlock [Pro](/pro/pro.md) features for your project.
!!!
...
Within the root of the `/en` directory, you should see a new `retype.yml` file. The `retype.yml` file contains the Retype [project](/configuration/project.md) settings and can be customized to your requirements.
...
lastUpdated:
  date:
    enabled: false # Remove or set to true to enable
```
