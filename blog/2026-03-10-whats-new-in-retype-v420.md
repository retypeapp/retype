...
See the full [Changelog](/changelog.md) and [Feature Log](/feature-log.md) for a detailed list of updates in the `v4.2` release.
...
All label keys are available in the [translations](/configuration/translations.md) configuration reference.
