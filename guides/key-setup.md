...
The key can be added as an [Environment Variable](/configuration/envvars.md), which is recommended for building and hosting on services such as [GitHub Pages](/hosting/github-pages.md), [Netlify](/hosting/netlify.md), and [Cloudflare](/hosting/cloudflare.md).

Then add `RETYPE_KEY` secret to your [GitHub Actions](/guides/github-actions.md) file:
