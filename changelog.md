...
Released: [2025-06-26](https://github.com/retypeapp/retype/releases/tag/v3.11.2-preview)

Getting info about the 'v3.11.2' milestone: 2 open milestones, failed.
::error::No milestone matching version: 3.11.2-preview
- Looked for: v3.11.2)
